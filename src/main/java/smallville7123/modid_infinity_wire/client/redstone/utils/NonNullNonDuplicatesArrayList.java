 ...
 * and it does not permit <tt>duplicate</tt> elements.
 *
...
public class NonNullNonDuplicatesArrayList<E> extends ArrayList<E> {
    /**
     ...
     *                                  is negative
     */
    public NonNullNonDuplicatesArrayList(int initialCapacity) {
     ...
     */
    public NonNullNonDuplicatesArrayList() {
        super();
    }
     ...
     */
    public NonNullNonDuplicatesArrayList(Collection<? extends E> c) {
        super();
        addAll(c);
    }
    ...
    public boolean add(E e) {
        ...
        if (contains(e)) {
            throw new NullPointerException("cannot add a duplicate element");
        }
