...
//
//public class InfinityWire_BLOCK extends Block
//{
//    public static final PropertyEnum<InfinityWire_BLOCK.EnumAttachPosition> NORTH = PropertyEnum.<InfinityWire_BLOCK.EnumAttachPosition>create("north", InfinityWire_BLOCK.EnumAttachPosition.class);
//    public static final PropertyEnum<InfinityWire_BLOCK.EnumAttachPosition> EAST = PropertyEnum.<InfinityWire_BLOCK.EnumAttachPosition>create("east", InfinityWire_BLOCK.EnumAttachPosition.class);
//    public static final PropertyEnum<InfinityWire_BLOCK.EnumAttachPosition> SOUTH = PropertyEnum.<InfinityWire_BLOCK.EnumAttachPosition>create("south", InfinityWire_BLOCK.EnumAttachPosition.class);
//    public static final PropertyEnum<InfinityWire_BLOCK.EnumAttachPosition> WEST = PropertyEnum.<InfinityWire_BLOCK.EnumAttachPosition>create("west", InfinityWire_BLOCK.EnumAttachPosition.class);
...
//
//    public InfinityWire_BLOCK()
//    {
//        super(Material.CIRCUITS);
//        this.setDefaultState(this.blockState.getBaseState().withProperty(NORTH, InfinityWire_BLOCK.EnumAttachPosition.NONE).withProperty(EAST, InfinityWire_BLOCK.EnumAttachPosition.NONE).withProperty(SOUTH, InfinityWire_BLOCK.EnumAttachPosition.NONE).withProperty(WEST, InfinityWire_BLOCK.EnumAttachPosition.NONE).withProperty(POWER, Integer.valueOf(0)));
//    }
//
...
//    {
//        int i = 0;
//        boolean flag = state.getValue(NORTH) != InfinityWire_BLOCK.EnumAttachPosition.NONE;
//        boolean flag1 = state.getValue(EAST) != InfinityWire_BLOCK.EnumAttachPosition.NONE;
//        boolean flag2 = state.getValue(SOUTH) != InfinityWire_BLOCK.EnumAttachPosition.NONE;
//        boolean flag3 = state.getValue(WEST) != InfinityWire_BLOCK.EnumAttachPosition.NONE;
//
...
//    }
//
//    private InfinityWire_BLOCK.EnumAttachPosition getAttachPosition(IBlockAccess worldIn, BlockPos pos, EnumFacing direction)
//    {
...
//                    {
//                        return InfinityWire_BLOCK.EnumAttachPosition.UP;
//                    }
//
//                    return InfinityWire_BLOCK.EnumAttachPosition.SIDE;
//                }
//            }
//
//            return InfinityWire_BLOCK.EnumAttachPosition.NONE;
//        }
//        else
//        {
//            return InfinityWire_BLOCK.EnumAttachPosition.SIDE;
...
//    {
//        return InfinityWire.Items.InfinityWire_Item;
//    }
//
...
//
//        if (block == Blocks.REDSTONE_WIRE || block == InfinityWire.Blocks.InfinityWire_Block)
//        {
//            return true;
//        }
...
//    {
//        return new ItemStack(InfinityWire.Items.InfinityWire_Item);
//    }
//
