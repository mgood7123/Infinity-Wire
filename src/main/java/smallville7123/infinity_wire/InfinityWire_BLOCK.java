...
public class InfinityWire_BLOCK extends Block
{
    ...
    {
        return Main.Registered.InfinityWire_Item;
    }
    ...
    protected static boolean canConnectTo(IBlockState blockState, @Nullable EnumFacing side, IBlockAccess world, BlockPos pos)
    {
        ...
        if (block == Blocks.REDSTONE_WIRE || block == Main.Registered.InfinityWire_Block)
        {
            return true;
        }
    ...
    {
        return new ItemStack(Main.Registered.InfinityWire_Item);
    }
